...
otx() {
	/mnt/c/Program\ Files\ \(x86\)/Google/Chrome/Application/chrome.exe "https://otx.alienvault.com/browse/pulses/?q=$@"
}
...
ipinfo() {
	/mnt/c/Program\ Files\ \(x86\)/Google/Chrome/Application/chrome.exe "http://rothe.uk/share/ip/ip.html?ip=$@"
}
